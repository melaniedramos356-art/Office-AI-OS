...
class PPTAgent:
    ...
    def build_slides(self, presentation_type):
        ...
        if presentation_type == "项目汇报":
            return [
                {"title": "项目已进入可控推进阶段", "bullets": ["目标和范围已经明确", "核心任务正在按阶段推进", "当前重点是把成果沉淀为可交付内容"]},
                {"title": "阶段成果已经形成交付基础", "bullets": ["关键任务完成情况可追踪", "已交付内容支撑后续迭代", "过程经验可以复用到下一阶段"]},
                {"title": "风险集中在协同、时间和质量", "bullets": ["责任边界需要继续明确", "关键节点需要提前预警", "成果质量需要统一检查标准"]},
                {"title": "下一阶段要聚焦落地结果", "bullets": ["明确负责人和截止时间", "补齐数据、案例和证明材料", "建立复盘机制并持续优化"]},
            ]
        ...
        return [
            {"title": "当前事项需要形成清晰判断", "bullets": ["说明为什么要做", "梳理当前基础", "明确汇报目标"]},
            {"title": "核心内容围绕重点问题展开", "bullets": ["突出最关键的信息", "减少无关背景", "让每页只表达一个重点"]},
            {"title": "主要结论要放在表达前面", "bullets": ["先给判断，再给依据", "用事实支撑观点", "避免只罗列过程"]},
            {"title": "后续行动需要明确责任和时间", "bullets": ["列出下一步动作", "明确负责人", "说明完成时间"]},
        ]
